      ...
      <Page dictionary={this.state.dictionary} showDictionary={true} showAddLink={this.state.canEdit} showSettingLink={this.state.canOwn}>
        <Loading loading={this.state.dictionary === null}>
          <div styleName="search-form">
            <SearchForm dictionary={this.state.dictionary!} parameter={this.state.parameter} showOrder={true} showAdvancedSearch={true} onParameterSet={this.handleParameterSet.bind(this)}/>
          </div>
          {innerNode}
        </Loading>
      </Page>
