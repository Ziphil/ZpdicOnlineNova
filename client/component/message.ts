...
const MESSAGES = {
  ...
  dictionaryParamNameChanged: "辞書の URL 用の名称を変更しました。",
  ...
  duplicateDictionaryParamName: "その URL 用の名称はすでに利用されています。別の名称をしてしてください。",
  invalidDictionaryParamName: "URL 用の名称が不正です。半角英数字とアンダーバーとハイフンのみで構成され、数字以外の文字が 1 文字以上含まれている必要があります。",
