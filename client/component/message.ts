...
const MESSAGES = {
  ...
  dictionaryAuthorizedUserDeleted: "該当ユーザーの編集権限を削除しました。",
  ...
  noSuchDictionaryAuthorizedUser: "そのような権限を保有しているユーザーは存在しません。",
  ...
  recaptchaError: "reCAPTCHA がエラーを返しました。もう一度お試しください。",
  recaptchaRejected: "reCAPTCHA による認証に失敗しました。もう一度お試しください。",
