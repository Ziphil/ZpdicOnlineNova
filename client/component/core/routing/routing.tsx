...
const router = createBrowserRouter(createRoutesFromElements(
  <Route path="/" element={<ToplevelRoute/>} errorElement={<ErrorPage/>}>
    ...
    <Route path="/all-words" lazy={() => import("/client/component/page/search-words-globally-page")}/>
    <Route path="/dictionary/:identifier" lazy={() => import("/client/component/page/dictionary-page")}>
      ...
      <Route path="articles/:articleNumber" lazy={() => import("/client/component/page/dictionary-article-single-part")}/>
      ...
      <Route path="requests" lazy={() => import("/client/component/page/dictionary-proposal-part")}/>
      <Route path="settings" lazy={() => import("/client/component/page/dictionary-setting-part")}>
        ...
        <Route path="display" lazy={() => import("/client/component/page/dictionary-setting-display-part")}/>
    ...
    <Route path="/dictionary/:identifier/download/:id" lazy={() => import("/client/component/page/download-dictionary-page")}/>
    <Route path="/dictionary/:identifier/upload/:id" lazy={() => import("/client/component/page/upload-dictionary-page")}/>
