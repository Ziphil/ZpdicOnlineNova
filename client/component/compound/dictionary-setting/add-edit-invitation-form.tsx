...
export default class AddEditInvitationForm extends Component<Props, State> {
  ...
  public render(): ReactNode {
    let node = (
      <Fragment>
        <form styleName="root">
          <Input label={this.trans("addEditInvitationForm.userName")} value={this.state.userName} prefix="@" suggest={this.suggestUsers.bind(this)} onSet={(userName) => this.setState({userName})}/>
