  ...
  function ({
    ...
    if (title !== undefined) {
      let backButtonNode = (page !== undefined && ((showBack === undefined && page > 0) || showBack)) && (
        <Button label={trans("overlay.back")} iconLabel="&#xF04A;" style="simple" hideLabel={true} onClick={onBack}/>
      );
      let closeButtonNode = (
        <Button label={trans("overlay.close")} iconLabel="&#xF00D;" style="simple" hideLabel={true} onClick={onClose}/>
      );
      let node = (
