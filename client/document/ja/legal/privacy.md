...
改定後の本プライバシーポリシーは、2026 年 7 月 13 日から適用されます。
それまでは、改定前のプライバシーポリシーが適用されます。
...
なお、メールの送信には外部サービスである [SendGrid](https://sendgrid.com/) を利用しており、メールの送信の際にメールアドレスが SendGrid に送信されます。
