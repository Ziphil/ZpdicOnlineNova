...
import {Example$Out} from "/server/external/schema/example/example";
import {Equivalent$In, Equivalent$Out} from "/server/external/schema/word/equivalent";
import {Information$In, Information$Out} from "/server/external/schema/word/information";
import {Phrase$In, Phrase$Out} from "/server/external/schema/word/phrase";
import {Relation$In, Relation$Out} from "/server/external/schema/word/relation";
import {Variation$In, Variation$Out} from "/server/external/schema/word/variation";
