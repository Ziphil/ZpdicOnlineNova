...
import {LinkedExampleOffer$In, LinkedExampleOffer$Out} from "/server/external/schema/example-offer/linked-example-offer";
import {LinkedWord$In, LinkedWord$Out} from "/server/external/schema/word/linked-word";
