...
import {FilledRequest, Response} from "/server/external-alpha/controller/rest/base";
import {ExternalRestController} from "/server/external-alpha/controller/rest/base";
import {checkDictionary, checkMe, limit} from "/server/external-alpha/controller/rest/middleware";
import {validateBody, validateQuery} from "/server/external-alpha/controller/rest/middleware/validate";
import {WordCreator, WordParameterCreator} from "/server/external-alpha/creator";
import {SERVER_PATH_PREFIX} from "/server/external-alpha/type/rest";
