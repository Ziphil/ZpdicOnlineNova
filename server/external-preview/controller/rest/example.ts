...
import {FilledRequest, Request, Response} from "/server/external-preview/controller/rest/base";
import {ExternalRestController} from "/server/external-preview/controller/rest/base";
import {checkDictionary, checkMe, limit} from "/server/external-preview/controller/rest/middleware";
import {validateBody, validateQuery} from "/server/external-preview/controller/rest/middleware/validate";
import {ExampleCreator, ExampleOfferCreator, ExampleOfferParameterCreator} from "/server/external-preview/creator";
import {ExampleParameterCreator} from "/server/external-preview/creator";
import {SERVER_PATH_PREFIX} from "/server/external-preview/type/rest";
...
export class ExampleExternalRestController extends ExternalRestController {
  ...
  @endpoint("/dictionary/:identifier/examples", "get")
  ...
  @endpoint("/dictionary/:identifier/example/:exampleNumber", "get")
  ...
  @endpoint("/dictionary/:identifier/example", "post")
  ...
  @endpoint("/dictionary/:identifier/example/:exampleNumber", "put")
  ...
  @endpoint("/dictionary/:identifier/example/:exampleNumber", "delete")
  ...
  @endpoint("/exampleOffer/:catalog/:exampleOfferNumber", "get")
